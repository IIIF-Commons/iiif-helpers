// @ts-nocheck
import { normaliseContentState, parseContentState, serialiseContentState } from '../../src/content-state';
...
describe('content state (presentation 4)', () => {
  ...
  describe('Normalisation variations', () => {
