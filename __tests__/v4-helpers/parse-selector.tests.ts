// @ts-nocheck
import type { Selector } from '@iiif/parser/presentation-4/types';
import { JSDOM } from 'jsdom';
import { describe, expect, test } from 'vitest';
import ghentChoices from '../../fixtures/presentation-4/upgraded-from-p3/p3--ghent-choices.json';
      ...
      expect(expandTarget(firstTarget)).toMatchInlineSnapshot(`
        {
          ...
          "source": {
            "id": "https://iiif.ghentcdh.ugent.be/iiif/manifests/cune-iiif-orm:sde:O.0219/canvas/0001",
            "type": "Canvas",
          },
