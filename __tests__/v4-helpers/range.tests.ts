// @ts-nocheck
import type { Range, RangeItems } from '@iiif/parser/presentation-4/types';
...
import tableOfContentManifests from '../../fixtures/presentation-4/upgraded-from-p3/cookbook--toc.json';
import tableOfContentsAvManifest from '../../fixtures/presentation-4/upgraded-from-p3/cookbook--toc-av.json';
import blManifest from '../../fixtures/presentation-4/upgraded-from-p3/p3--bl-av-manifest.json';
import { isRangeContiguous, rangesToTableOfContentsTree, rangeToTableOfContentsTree } from '../../src';
import { Vault4 } from '../../src/vault/vault4';
import { copy, rangeMaker, renderRange } from './helpers';
